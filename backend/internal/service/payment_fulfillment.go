...
func (s *PaymentService) doSub(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	_, _, err = s.subscriptionSvc.StartNewSubscriptionCycle(ctx, &AssignSubscriptionInput{UserID: o.UserID, GroupID: gid, ValidityDays: days, AssignedBy: 0, Notes: orderNote})
	if err != nil {
