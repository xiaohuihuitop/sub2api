...
func (_c *SubscriptionPlanCreate) AddAPIKeyIDs(ids ...int64) *SubscriptionPlanCreate {
	_c.mutation.AddAPIKeyIDs(ids...)
	return _c
}

// AddAPIKeys adds the "api_keys" edges to the APIKey entity.
func (_c *SubscriptionPlanCreate) AddAPIKeys(v ...*APIKey) *SubscriptionPlanCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *SubscriptionPlanCreate) defaults() {
	...
	if _, ok := _c.mutation.RateMultiplier(); !ok {
		v := subscriptionplan.DefaultRateMultiplier
		_c.mutation.SetRateMultiplier(v)
	}
...
func (_c *SubscriptionPlanCreate) check() error {
	...
	if _, ok := _c.mutation.RateMultiplier(); !ok {
		return &ValidationError{Name: "rate_multiplier", err: errors.New(`ent: missing required field "SubscriptionPlan.rate_multiplier"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
