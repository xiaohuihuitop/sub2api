...
// QuerySubscriptionPlans queries the "subscription_plans" edge of the APIKey entity.
func (_m *APIKey) QuerySubscriptionPlans() *SubscriptionPlanQuery {
	return NewAPIKeyClient(_m.config).QuerySubscriptionPlans(_m)
}
