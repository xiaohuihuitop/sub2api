...
func (e GroupEdges) BillingProfileOrErr() (*BillingProfile, error) {
...
// QueryBillingProfile queries the "billing_profile" edge of the Group entity.
func (_m *Group) QueryBillingProfile() *BillingProfileQuery {
	return NewGroupClient(_m.config).QueryBillingProfile(_m)
}
