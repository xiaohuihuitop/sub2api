...
func (_q *BillingProfileQuery) QueryGroup() *GroupQuery {
...
func (_q *BillingProfileQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *BillingProfileQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *BillingProfileQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *BillingProfileQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *BillingProfileQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *BillingProfileQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BillingProfileQuery) WithGroup(opts ...func(*GroupQuery)) *BillingProfileQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
//		GroupBy(billingprofile.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.BillingProfile.Query().
//		Select(billingprofile.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *BillingProfileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BillingProfile, error) {
	...
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *BillingProfile, e *Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *BillingProfileQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*BillingProfile, init func(*BillingProfile), assign func(*BillingProfile, *Group)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*BillingProfile)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (_q *BillingProfileQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(billingprofile.Table, billingprofile.Columns, sqlgraph.NewFieldSpec(billingprofile.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(billingprofile.FieldGroupID)
		}
	}
