...
func (_q *PlatformQuery) QueryModelRules() *PlatformModelRuleQuery {
	query := (&PlatformModelRuleClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PlatformQuery) QueryAPIKeys() *APIKeyQuery {
...
func (_q *PlatformQuery) QueryUsageLogs() *UsageLogQuery {
...
// the "model_rules" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *PlatformQuery) WithModelRules(opts ...func(*PlatformModelRuleQuery)) *PlatformQuery {
	query := (&PlatformModelRuleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withModelRules = query
	return _q
}
...
func (_q *PlatformQuery) WithAPIKeys(opts ...func(*APIKeyQuery)) *PlatformQuery {
	query := (&APIKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlatformQuery) WithUsageLogs(opts ...func(*UsageLogQuery)) *PlatformQuery {
	query := (&UsageLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlatformQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Platform, error) {
	...
	if query := _q.withModelRules; query != nil {
		if err := _q.loadModelRules(ctx, query, nodes,
			func(n *Platform) { n.Edges.ModelRules = []*PlatformModelRule{} },
			func(n *Platform, e *PlatformModelRule) { n.Edges.ModelRules = append(n.Edges.ModelRules, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAPIKeys; query != nil {
		if err := _q.loadAPIKeys(ctx, query, nodes,
			func(n *Platform) { n.Edges.APIKeys = []*APIKey{} },
			func(n *Platform, e *APIKey) { n.Edges.APIKeys = append(n.Edges.APIKeys, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUsageLogs; query != nil {
		if err := _q.loadUsageLogs(ctx, query, nodes,
			func(n *Platform) { n.Edges.UsageLogs = []*UsageLog{} },
			func(n *Platform, e *UsageLog) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PlatformQuery) loadModelRules(ctx context.Context, query *PlatformModelRuleQuery, nodes []*Platform, init func(*Platform), assign func(*Platform, *PlatformModelRule)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(platformmodelrule.FieldPlatformID)
	}
	query.Where(predicate.PlatformModelRule(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(platform.ModelRulesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PlatformQuery) loadAPIKeys(ctx context.Context, query *APIKeyQuery, nodes []*Platform, init func(*Platform), assign func(*Platform, *APIKey)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Platform)
	nids := make(map[int64]map[*Platform]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(platform.APIKeysTable)
		s.Join(joinT).On(s.C(apikey.FieldID), joinT.C(platform.APIKeysPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(platform.APIKeysPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(platform.APIKeysPrimaryKey[1]))
...
func (_q *PlatformQuery) loadUsageLogs(ctx context.Context, query *UsageLogQuery, nodes []*Platform, init func(*Platform), assign func(*Platform, *UsageLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Platform)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(usagelog.FieldPlatformID)
	}
	query.Where(predicate.UsageLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(platform.UsageLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PlatformQuery) ForUpdate(opts ...sql.LockOption) *PlatformQuery {
...
func (_q *PlatformQuery) ForShare(opts ...sql.LockOption) *PlatformQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
