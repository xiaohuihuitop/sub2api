...
func (e PlatformEdges) LegacyGroupOrErr() (*Group, error) {
...
// QueryLegacyGroup queries the "legacy_group" edge of the Platform entity.
func (_m *Platform) QueryLegacyGroup() *GroupQuery {
	return NewPlatformClient(_m.config).QueryLegacyGroup(_m)
}
