...
const (
	...
	PlatformsTable = "api_key_platforms"
	...
	SubscriptionPlansTable = "api_key_subscription_plans"
...
var (
	...
	PlatformsPrimaryKey = []string{"api_key_id", "platform_id"}
	...
	SubscriptionPlansPrimaryKey = []string{"api_key_id", "subscription_plan_id"}
)
