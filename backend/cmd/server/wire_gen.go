...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingService := service.ProvideSettingService(settingRepository, groupRepository, proxyRepository, paymentConfigService, configConfig)
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, paymentConfigService)
	...
	platformRepository := repository.NewPlatformRepository(db)
	platformService := service.NewPlatformService(platformRepository)
	apiKeyHandler := handler.ProvideAPIKeyHandler(apiKeyService, platformService)
	...
	platformHandler := handler.ProvideAdminPlatformHandler(platformService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, platformService, compositeRouteResolver, redisClient)
