      ...
      <template #table>
        ...
        >
          ...
          <template #cell-group="{ row }">
            <div class="flex max-w-[360px] flex-wrap items-center gap-1.5" data-test="key-group-list">
              <template v-if="displayGroups(row).length > 0">
                <GroupBadge
...
const displayGroups = (key: ApiKey): Group[] => {
