export default {
  ...
  keys: {
    ...
    platformsLabel: 'Platform Pools',
    platformsHint: 'Select the independent platform pools this key may schedule.',
    noPlatforms: 'No platform pools are available for authorization',
    noPlatformsAuthorized: 'No platform pool authorized',
    unavailablePlatform: 'Unavailable platform #{id}',
    subscriptionPlansLabel: 'Chargeable Subscription Plans',
    subscriptionPlansHint: 'Valid subscriptions are charged first. Balance can be used without a subscription.',
    noActiveSubscriptionPlans: 'No active subscription plan is available',
    subscriptionPlanFallback: 'Plan #{id}',
    unavailableSubscriptionPlan: 'Unavailable plan #{id}',
    balanceLabel: 'Allow Balance',
    ...
    legacyAuthorization: 'Legacy group authorization requires manual migration',
    platformRequired: 'Select at least one platform pool',
