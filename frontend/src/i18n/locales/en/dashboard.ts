export default {
  ...
  keys: {
    ...
    noPlatformsAuthorized: 'No platform authorized',
    ...
    useKeyModal: {
      ...
      noPlatformTitle: 'Authorize a platform first',
      noPlatformDescription: 'This API key has no authorized platform. Select at least one platform in the key editor before viewing the configuration.',
      openai: {
