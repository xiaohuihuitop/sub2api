export default {
  ...
  home: {
    ...
    planDescription: 'Buy a plan or redeem a code to activate your access.',
    consoleDescription: 'Sign in to manage keys, balance, and usage from your dashboard.',
    buyPlan: 'Buy Plan',
    redeemPlan: 'Redeem Plan',
