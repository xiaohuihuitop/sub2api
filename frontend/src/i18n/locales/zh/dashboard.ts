export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    platformsLabel: '平台账号池',
    platformsHint: '勾选此密钥可调度的独立平台账号池。',
    noPlatforms: '当前没有可授权的平台账号池',
    noPlatformsAuthorized: '尚未授权平台账号池',
    unavailablePlatform: '不可用平台 #{id}',
    subscriptionPlansLabel: '允许扣费的套餐',
    subscriptionPlansHint: '有效套餐优先扣费；未选择套餐时可仅使用余额。',
    noActiveSubscriptionPlans: '当前没有可选的有效套餐',
    subscriptionPlanFallback: '套餐 #{id}',
    unavailableSubscriptionPlan: '不可用套餐 #{id}',
    balanceLabel: '允许使用余额',
    balanceHint: '套餐不可用或已耗尽时，允许按全局余额倍率使用余额扣费。',
    balanceEnabled: '余额',
    noBillingSource: '未授权扣费资产',
    legacyAuthorization: '旧分组授权，需手动迁移',
    platformRequired: '请至少选择一个平台账号池',
