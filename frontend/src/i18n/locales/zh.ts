export default {
  ...
  home: {
    ...
    planTitle: '套餐',
    consoleTitle: '控制台',
    planDescription: '购买新套餐，或使用兑换码激活套餐。',
    consoleDescription: '登录后进入后台查看额度、密钥和使用情况。',
    buyPlan: '购买套餐',
    redeemPlan: '兑换套餐',
    loginConsole: '登录控制台',
    enterConsole: '进入控制台',
  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc: '仅对 OpenAI API Key 生效。自动跟随探测结果，强制模式会覆盖自动探测。',
        ...
        endpointCapabilities: '接口能力',
        endpointCapabilitiesDesc: '取消勾选此 API Key 上游不支持的接口。未写入自定义配置时保持旧的全接口行为。',
