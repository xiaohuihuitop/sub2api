 ...
 * 带 token 请求时后端会按可访问分组展示价目；不提供用户专属余额倍率。
 */
...
export interface ModelPlazaGroup {
  ...
  balance_peak_rate_enabled: boolean
  balance_peak_start: string
  balance_peak_end: string
  balance_peak_rate_multiplier: number
